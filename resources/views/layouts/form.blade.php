          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="{{ route('login') }}">
                ...
                <span class="nav-link-inner--text">Iniciar de sesión</span>
              </a>
            </li>
    ...
    <footer class="py-5">
      <div class="container">
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-x-left text-muted">
              © 2023 Pablodrom <a href="/" class="font-weight-bold ml-1" >{{ config('app.name') }}</a>
            </div>
          </div>
          <div class="col-xl-6">
